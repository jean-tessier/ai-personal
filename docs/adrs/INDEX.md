...
| [0006](ADR-0006-harness-variant-subdirectories-in-suites.md) | Harness-Variant Subdirectories Within a Suite | accepted | Multi-harness suites get per-harness subdirs named by harnesses.json keys; shared canonical docs stay at the suite root | 2026-07-09 |
| [0008](ADR-0008-suite-manifest-resource-kind-placements.md) | Suite Manifest Schema — Harness-Keyed Resource-Kind Placements | accepted | Colocated manifest.json declares per-harness placements (kind, src, mode); harnesses.json owns per-kind destinations | 2026-07-16 |
