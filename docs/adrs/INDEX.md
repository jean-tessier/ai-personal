...
| [0007](ADR-0007-colocated-dependency-manifest.md) | Colocated Dependency Manifest, Resolved to a Fixed Point | accepted | Declare asset deps as a colocated dependencies.json array, not a central manifest; install.sh resolves to a fixed point | 2026-07-12 |
