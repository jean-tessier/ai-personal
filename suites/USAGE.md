...
The first two suites in this workspace produce/consume files in a **target project**
...
All three are populated (no empty/placeholder suites currently exist in this workspace).
